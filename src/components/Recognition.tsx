...
function Recognition() {
  return (
    ...
    <div className='recognition-container'>
      <h1 className="recognition-h1">Your Music <span className="deserves-span">Deserves</span> More Recognition</h1>
      ...
      <img src={Ellipse} alt="Ellipse" className="recognition-ellipse"/>
